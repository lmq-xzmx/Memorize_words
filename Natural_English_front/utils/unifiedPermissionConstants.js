...
// ==================== 权限分类映射 ====================
export const PERMISSION_CATEGORY_MAP = {
...
// ==================== 权限分类显示名称 ====================
export const PERMISSION_CATEGORY_DISPLAY_NAMES = {
...
// ==================== 旧版权限映射（兼容性） ====================
export const LEGACY_PAGE_PERMISSIONS = {
  '/': 'view_word_learning',
 ...
 * @returns {boolean} role1是否比role2级别更高
 */
